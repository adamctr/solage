...
-- -----------------------------------------------------------------------------
INSERT INTO likes (user_id, post, response, created_at) VALUES
    -- p1 Alice's prod launch — everyone celebrates (9 likes)
    (2, 1, NULL, '2026-05-10 09:20:00'), (3, 1, NULL, '2026-05-10 09:25:00'),
    (4, 1, NULL, '2026-05-10 09:31:00'), (5, 1, NULL, '2026-05-10 10:02:00'),
    (6, 1, NULL, '2026-05-10 10:15:00'), (7, 1, NULL, '2026-05-10 11:00:00'),
    (8, 1, NULL, '2026-05-10 12:30:00'), (9, 1, NULL, '2026-05-10 14:00:00'),
    (10,1, NULL, '2026-05-10 16:45:00'),

    -- p2 refactor
    (1, 2, NULL, '2026-05-10 15:00:00'), (3, 2, NULL, '2026-05-10 15:10:00'),
    (5, 2, NULL, '2026-05-10 16:20:00'), (7, 2, NULL, '2026-05-10 18:00:00'),

    -- p3 MVC thread
    (1, 3, NULL, '2026-05-09 19:00:00'), (6, 3, NULL, '2026-05-09 19:05:00'),
    (8, 3, NULL, '2026-05-09 21:00:00'),

    -- p4 pizza
    (1, 4, NULL, '2026-05-09 12:30:00'), (7, 4, NULL, '2026-05-09 12:40:00'),
    (10,4, NULL, '2026-05-09 14:00:00'),

    -- p5 Docker rage (devs solidaires)
    (1, 5, NULL, '2026-05-08 22:30:00'), (3, 5, NULL, '2026-05-09 08:00:00'),
    (4, 5, NULL, '2026-05-09 09:15:00'),

    -- p6 marathon — 7 likes
    (1, 6, NULL, '2026-05-08 17:00:00'), (2, 6, NULL, '2026-05-08 17:30:00'),
    (3, 6, NULL, '2026-05-08 18:00:00'), (4, 6, NULL, '2026-05-08 19:00:00'),
    (5, 6, NULL, '2026-05-08 20:00:00'), (7, 6, NULL, '2026-05-08 21:00:00'),
    (9, 6, NULL, '2026-05-09 08:00:00'),

    -- p8 PostgreSQL
    (1, 8, NULL, '2026-05-07 10:00:00'), (3, 8, NULL, '2026-05-07 10:30:00'),
    (6, 8, NULL, '2026-05-07 11:00:00'),

    -- p9 Brass Birmingham
    (1, 9, NULL, '2026-05-06 19:30:00'), (5, 9, NULL, '2026-05-06 20:00:00'),

    -- p10 Alice no-SQL — devs hochent la tête
    (2, 10, NULL, '2026-05-06 14:30:00'), (3, 10, NULL, '2026-05-06 14:35:00'),
    (4, 10, NULL, '2026-05-06 14:50:00'), (6, 10, NULL, '2026-05-06 15:30:00'),
    (9, 10, NULL, '2026-05-06 18:00:00'),

    -- p11 café froid
    (2, 11, NULL, '2026-05-05 20:45:00'), (4, 11, NULL, '2026-05-05 21:00:00'),

    -- p13 risotto
    (1, 13, NULL, '2026-05-04 21:30:00'), (4, 13, NULL, '2026-05-04 22:00:00'),
    (7, 13, NULL, '2026-05-05 08:00:00'), (9, 13, NULL, '2026-05-05 09:00:00'),

    -- p14 security checklist
    (1, 14, NULL, '2026-05-04 09:00:00'), (2, 14, NULL, '2026-05-04 09:15:00'),
    (4, 14, NULL, '2026-05-04 10:00:00'), (6, 14, NULL, '2026-05-04 11:00:00'),
    (10,14, NULL, '2026-05-04 14:00:00'),

    -- p15 FrankenPHP
    (1, 15, NULL, '2026-05-03 18:00:00'), (2, 15, NULL, '2026-05-03 18:30:00'),
    (3, 15, NULL, '2026-05-03 19:00:00'), (8, 15, NULL, '2026-05-03 20:00:00'),

    -- p17 Dune 3
    (5, 17, NULL, '2026-05-02 22:30:00'), (10,17, NULL, '2026-05-02 23:00:00'),

    -- p18 SQL prophet — 6 likes
    (1, 18, NULL, '2026-05-02 16:00:00'), (2, 18, NULL, '2026-05-02 16:15:00'),
    (3, 18, NULL, '2026-05-02 16:30:00'), (5, 18, NULL, '2026-05-02 17:00:00'),
    (6, 18, NULL, '2026-05-02 17:30:00'), (9, 18, NULL, '2026-05-02 18:00:00'),

    -- p19 Lyon
    (4, 19, NULL, '2026-05-01 20:00:00'), (5, 19, NULL, '2026-05-01 21:00:00'),
    (8, 19, NULL, '2026-05-01 22:00:00'),

    -- p20 code review du mois
    (3, 20, NULL, '2026-05-01 10:30:00'), (5, 20, NULL, '2026-05-01 11:00:00'),
    (6, 20, NULL, '2026-05-01 12:00:00'), (8, 20, NULL, '2026-05-01 13:00:00'),
    (10,20, NULL, '2026-05-01 14:00:00'),

    -- p21 partial index
    (1, 21, NULL, '2026-04-30 14:30:00'), (3, 21, NULL, '2026-04-30 14:45:00'),
    (6, 21, NULL, '2026-04-30 15:00:00'),

    -- p22 concert
    (4, 22, NULL, '2026-04-29 18:30:00'), (8, 22, NULL, '2026-04-29 19:00:00'),
    (9, 22, NULL, '2026-04-29 20:00:00');

-- -----------------------------------------------------------------------------
-- users_favorites_posts  — David (the demo user) bookmarks a few standouts.
-- -----------------------------------------------------------------------------
INSERT INTO users_favorites_posts (user_id, post) VALUES
    (4, 1),    -- Alice's prod launch
    (4, 14),   -- Clara's security checklist
    (4, 18),   -- Gabrielle's SQL rant
    (4, 21),   -- Bob's partial index puzzle
    (1, 6),    -- Alice ♥ Hugo's marathon
    (3, 15),   -- Clara ♥ Félix's FrankenPHP
    (7, 13);   -- Gabrielle ♥ Emma's risotto
