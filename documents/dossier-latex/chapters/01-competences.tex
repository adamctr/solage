...
C4 & Contribuer à la gestion d'un projet informatique & 1 & Git (commits conventionnels), \file{README.md} en tableau Kanban, journal de décisions technique & \textcolor{juryGreen}{\textbf{OK}} \\
...
C11 & Contribuer à la mise en production (DevOps) & 3 & Conteneurs, migrations, intégration continue (CI) & \textcolor{juryGreen}{\textbf{OK}} \\
\bottomrule
\end{tabularx}
...
professionnelles :
\begin{itemize}
  \item \textbf{Communiquer en français et en anglais} : dossier et présentation structurés en
        français ; lecture de documentation technique en anglais (OWASP, manuel PHP) et
        \emph{nommage du code en anglais} — identifiants, méthodes, messages de \emph{commit}
        (niveau B1) ;
  \item \textbf{Mettre en œuvre une démarche de résolution de problème} : voir le
        chapitre~\ref{ch:bilan} (bugs diagnostiqués et résolus : \emph{headers already sent},
        requête N+1) ;
