...
C4 & Contribuer à la gestion d'un projet informatique & 1 & Git, feuille de route, journal de décisions & \textcolor{todoOrange}{\textbf{Partiel}} \\
C5 & Analyser les besoins et maquetter une application & 2 & Expression des besoins (ch.~\ref{ch:besoins}), maquettes \& enchaînement & \textcolor{todoOrange}{\textbf{Partiel}} \\
...
C9 & Préparer et exécuter les plans de tests & 3 & Plan de tests + tests unitaires / sécurité (PHPUnit) & \textcolor{red}{\textbf{À développer}} \\
C10 & Préparer et documenter le déploiement & 3 & \file{docker-compose.prod.yml}, Traefik HTTPS, procédure & \textcolor{todoOrange}{\textbf{Partiel}} \\
